...
const About = () => {
    return (
    <div className='flex bg-black flex-col w-full e' id='about'>
         ...
         <div className='grid md:grid-cols-2 md:grid-rows-auto w-full p-1 justify-items-center gap-x-10 gap-y-10'>
                        ...
                        <p className='flex md:max-w-160 font-link text-md leading-6 font-medium h-max md:row-start-2 md:text-sm text-justify md:text-left'>
                            We are passionate about helping students and professionals unlock their true potential in Python Programming, Data Analysis, and Machine Learning. With a hands-on, personalized approach, we strive to make complex concepts accessible and engaging for learners at all levels. Our goal is to empower you with the knowledge and practical skills needed to thrive in the fast-growing fields of data analytics and AI. Whether you’re starting from scratch or looking to advance your expertise, we are here to guide you every step of the way, ensuring your learning journey is both fulfilling and impactful.
                        </p>
