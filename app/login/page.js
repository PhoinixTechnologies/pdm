          ...
          <div className="input phone-number-input">
            ...
            <div className="signin-opt">
                <div id="emailopt">
                  <Link href={'#'}>
                    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="24" viewBox="0 0 25 24" fill="none">
                      <path d="M20.4062 4H4.40625C3.30168 4 2.40625 4.89543 2.40625 6V18C2.40625 19.1046 3.30168 20 4.40625 20H20.4062C21.5108 20 22.4062 19.1046 22.4062 18V6C22.4062 4.89543 21.5108 4 20.4062 4Z" stroke="#0F172A" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                      <path d="M22.4062 7L13.4362 12.7C13.1275 12.8934 12.7706 12.996 12.4062 12.996C12.0419 12.996 11.685 12.8934 11.3763 12.7L2.40625 7" stroke="#0F172A" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
                    Sign in with email
                  </Link>
                </div>
                ...
                <div id="google-opt">
                  <Link href={'#'}>
                    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="24" viewBox="0 0 25 24" fill="none">
                      <g clip-path="url(#clip0_686_2002)">
                ...
                <div id="apple-opt">
                  <Link href={'#'}>
                    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="24" viewBox="0 0 25 24" fill="none">
                      <g clip-path="url(#clip0_686_2010)"> 
