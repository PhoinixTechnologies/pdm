    ...
    return (  
       ...
       bg-center" style={{backgroundImage:`url(${back}) `}} >
         ...
         <Navbar/>
           ...
           <p className='text-[#BDBCBC] w-70 md:w-120 p-2 text-center sm:max-md:w-100 sm:max-md:text-xl text-md/6 font-link'>We are passionate about helping
              students and professionals unlock their true potential <br />
              in Python Programming, Data Science and Machine Learning.
            </p>
           <div className='flex relative mt-10'>
            <button type="button" className='flex gap-x-0 w-max items-center px-5 py-3 rounded-4xl mt-0 h-max self-center'>
