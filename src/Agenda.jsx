...
const Agenda = () => {
    return ( 
      <div className='bg-black  p-20 py-40 flex flex-col gap-70 mt-10' id='Agenda'>
            <div className='flex justify-center items-center h-max relative'>
                ...
                <div className='absolute grid md:grid-cols-2 md:grid-rows-auto w-fit p-1 justify-items-center gap-x-10 gap-y-10 p-2 text-white inset-x-0 -top-60 md:top-30'>
                            ...
                            <div className='flex gap-x-4 items-center col-start-1 md:row-start-3 md:justify-self-start w-full justify-evenly md:justify-center md:justify-start'>
                                <a href="/" className='flex items-center px-4 py-4 w-max md:px-1 md:py-3 rounded-2xl bg-white text-black justify-center tracking-wide w-30 font-medium shadow-[inset_-4px_-4px_4px_rgba(0,0,0,0.1),_inset_4px_4px_4px_rgba(255,255,255,0.1)]'>Get started</a>
