...
import { Workshop } from "./pages/workshop/workshop.page.js";
import { Slideshow } from "./pages/register/slideshow.page.js";
        ...
        <AuthProvider>
          ...
          <Routes>
              ...
              <Route element={<PrivateRoute />}>
                ...
                <Route path="/workshop" exact element={<Workshop title="PDM - Tutor | WorkShop" />} />
              </Route>
          </Routes>
