...
const Home = () => {
    return (  
       <div className='border max-w-full  border '>
       ...
       bg-center" style={{backgroundImage:`url(${back}) `}} >
         <div className='bg-black/70 w-full h-full p-20 pt-50 flex flex-col items-center justify-start gap-y-5 box-border'>
           <h1  className='text-white text-6xl/16 font-semibold p-1 pb-5 text-center font-link'>Empowering Learners in Python,
           Data Analytics & Machine Learning</h1>

           <p className='text-[#BDBCBC] w-120 p-2 text-center text-md/6 font-link'>As a dedicated tutor, I am passionate about helping
              students and professionals unlock their true potential <br />
              in Python programming, data science and machine learning.
            </p>
           <div className='flex relative mt-10'>
            <button type="button" className='flex gap-x-0 bg-[#3935FF] w-max items-center px-5 py-3 rounded-4xl mt-0 h-max self-center'>
            ...
            <p className='text-white font-light self-center text-center w-30 text-lg/5 transform rotate-[10.943deg] self-start absolute -top-7 -right-17 font-dog'>All research start from here</p>
