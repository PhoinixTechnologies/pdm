...
import add_user_icon from '../../assets/images/add-user.png';
    ...
    <div className="reg-grid">
      ...
      <div className="pdm-register">
        ...
        <div className='signin-message'>
          <h3>Already have an account?<a href={'login'} className='login-link'><h4>Log in</h4></a></h3>
        </div>
          </div>
      <div className="div form-container" id="container-reg">
          {/* <div className='add-user'>
          <img src={add_user_icon} alt="adduser"></img>
        </div> */}
        ...
        <div className="box signup">
          ...
          <h3>Please enter your details to get started</h3>
          ...
          <form className="form-group" id="register-form" method="POST" action="#">
            ...
            <div id="horizontal-line-register"> <div className="line"> OR </div> </div>
            ...
            <div className="input contbutton">
              <button type="button" onClick={() => submitRegister()}>
                  {responseState === RESPONSE_STATES.loading ? <Loader /> : "Get Started"}
                </button>

                <h4>By signing up, you agree to the <span>Terms of Service</span> and <span>Privacy Policy,</span> including  <span>cookie use</span>.</h4>
            </div>
          </form>
        </div>
      </div>
